 ...
 * @LastEditors: lgq
 * @LastEditTime: 2024-12-10 09:55:42
			...
			<div class="l-tabs-content">
				...
				>
					<a-tab-pane
						...
						:key="item.key"
						:closable="
							routerSetting.redirect !== item.key &&
							layoutMenu.historyMenuList.length > 1
						"
					>
						<template #tab>
							<a-flex justify="space-between" align="center">
								...
								<!-- <IconFont
									v-if="layoutMenu.tabsActiveKey === item.key"
									name="ReloadOutlined"
									class="l-tab-reload"
									@click.native="refreshUnit"
								/> -->
							</a-flex>
						</template>
					</a-tab-pane>
...
<script lang="ts" setup>
	...
	const { layout, router: routerSetting } = configure;
